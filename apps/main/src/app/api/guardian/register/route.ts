...
/**
 * Guardian Registration - Moved to Tutorials App
 * 
 * Guardian registration is handled on tutorials.aotf.in
...
export async function POST() {
  ...
  return NextResponse.json(
    { 
      success: false, 
      error: 'Guardian registration is not available on the main app.',
