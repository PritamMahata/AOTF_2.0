...
export function AdBanner() {
  ...
  return (
    <div className="relative bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950 rounded-lg overflow-hidden shadow-md">
      <Button
        variant="ghost"
        size="icon"
