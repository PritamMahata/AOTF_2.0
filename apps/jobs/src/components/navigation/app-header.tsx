...
export function AppHeader({
  ...
  const handleNavigation = (path: string) => {
    if (onNavigate) {
      ...
      // For external routes (main app), redirect to main app URL
      const externalRoutes = ['/about', '/contact'];
      if (externalRoutes.includes(path)) {
  ...
  const handleLogout = async () => {
    try {
      ...
      if (data.success) {
        ...
        // Redirect to main app instead of jobs app root
