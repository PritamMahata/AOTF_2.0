...
const BottomNav = () => {
  ...
  const [dashboardHref, setDashboardHref] = React.useState("/freelancer");
  const [profileHref, setProfileHref] = React.useState("/freelancer/profile");
  ...
  React.useEffect(() => {
    ...
    const init = async () => {
      ...
      setProfileHref(isClient ? "/client/profile" : "/freelancer/profile");
    };
    init();
    return () => {
      canceled = true;
  ...
  const isActive = React.useCallback(
    (href: string) => {
      ...
      if (href === dashboardHref) {
        return (
          pathname === href ||
          (pathname.startsWith(href + "/") && !pathname.startsWith(profileHref))
        );
      }
  ...
  const navigationItems = [
    ...
    { name: "Projects", href: "/posts", icon: Users, external: false },
    {
      name: "Dashboard",
      href: dashboardHref,
    ...
    { name: "Profile", href: profileHref, icon: User, external: false },
  ];
